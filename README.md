...
- **Everything OpenAI Codex** – [GitHub: mturac/everything-openai-codex](https://github.com/mturac/everything-openai-codex) – MIT-licensed OpenAI Codex workflow system with agents, skills, commands, hooks, install profiles, validation checks, and session memory for repeatable coding work.
