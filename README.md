...
- **eoc (Everything OpenAI Codex)** – [GitHub: mturac/everything-openai-codex](https://github.com/mturac/everything-openai-codex) – Cross-harness workflow system that transforms raw AI agent harnesses into repeatable engineering environments with 230+ skills, 60 agents, quality gates, and session memory. Works across Codex, Cursor, Gemini CLI, Copilot, and more.
